...
/**
 * Configuration class for Odoo integration settings.
 * This class manages the Odoo configuration properties including:
 * - Odoo server connection (URL, database, credentials)
 * - Model mappings for various Odoo entities
 * <p>
 * The configuration is populated through Spring's property injection
...
public class OdooConfig {
    ...
    /**
     * Inner class representing the Odoo model mappings.
     * Contains the technical names of various Odoo models used in the integration.
     */
    @Getter
    @Setter
